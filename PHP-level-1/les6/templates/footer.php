<?php
  echo
  "<footer>
		<div class='worldwide_delivery'>
			<div class='container worldwide_delivery_flex'>
				<div>
					<img src='img/truck.png' alt='Track'>
					<p>Free Delivery</p>
					<p>Worldwide delivery on all. Authorit tively morph next-generation innov tion with extensive models.</p>
				</div>
				<div>
					<img src='img/sale.png' alt='Track'>
					<p>Sales & discounts</p>
					<p>Worldwide delivery on all. Authorit tively morph next-generation innov tion with extensive models.</p>
				</div>
				<div>
					<img src='img/crown.png' alt='Track'>
		...
		<div class='subscribe'>
			<div class='container subscribe_flex'>
				<div class='feed_back'>
					<img src='img/layer-40.png' alt='foto'>
					<i>
					...
					<p>
						<span>Bin Burhan</span> Dhaka, Bd
					</p>
					<a href='#'></a>
					<a class='active_slide' href='#'></a>
					<a href='#'></a>
				</div>
				<div class='newletter'>
		...
		<div class='container footer_flex'>
			<div class='about_us'>
				...
				<div class='about_us_p'>
					...
					<p>Compellingly envisioneer corporate methods of empowerment before standards compliant technologies. Objectively facilitate progressive.
					</p>
				</div>
			</div>
